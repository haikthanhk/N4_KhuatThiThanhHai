...
{
    public partial class KoreaNewsContext : DbContext
    {
        public KoreaNewsContext()
        {
        }

        public KoreaNewsContext(DbContextOptions<KoreaNewsContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                if (!optionsBuilder.IsConfigured)
                {
                    ...
                    optionsBuilder.UseSqlServer(config.GetConnectionString("KoreaNewsDB"));
                }
            }
        }
