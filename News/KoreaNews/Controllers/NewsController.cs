...
namespace KoreaNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        public IActionResult NewsList(int CategoryId, int Page)
        {
            ...
            {
                ViewData["CategoryName"] = " " + GetCategory.CategoryName;
            }
            else
            {
                ViewData["CategoryName"] = "Korea News " + GetCategory.CategoryName;
            }
        ...
        public IActionResult SearchNews(string NewsValue)
        {
            ...
            NewsManager newsManager = new NewsManager();
            ViewBag.Top5LatestNews = newsManager.GetTop5LatestNews();
            ViewData["CategoryName"] = "Korea News";
            ...
            {
                ViewData["Result"] = "There is(are) " + news.Count + " resuluts for '" + NewsValue + "'";
            }
            else
            {
                ViewData["Result"] = "No results containing all your search terms were found. '" + NewsValue + "'";
            }
